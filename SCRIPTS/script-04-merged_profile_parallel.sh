...
then
/workspace/jmarkwelchlab/P_0622_Haemophilus_Aggregatibacter/SCRIPTS/script-merged_profile-HP.sh ${projectID} ${site} &
fi
...
do
	...
	/workspace/jmarkwelchlab/P_0622_Haemophilus_Aggregatibacter/SCRIPTS/script-merged_profile.sh ${projectID} ${site} &
	fi
done
